...
const { getPackages, getPackage, updatePackage, deletePackage, createPackage, getInvestments, getInvestment, updateInvestment, deleteInvestment,sendEmail } = require("../controller/admin")
